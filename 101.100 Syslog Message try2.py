...
api_endpoint = 'https://tp-prtg-101-100.comtelindia.com:10443/api/table.xml?content=messages&columns=objid,datetime,parent,type,name,status,message&id=3022&username=Ashwin.Gedekar&passhash=3422185132'
#http://MY_PRTG_SERVER/api/table.xml?content=messages&columns=objid,datetime,parent,type,name,status,message&id=3022
